...
public final class Constants {
    ...
    public static final double TRANSLATION_P_CONSTANT = .013;
    public static final double TRANSLATION_I_CONSTANT = 0;
    public static final double TRANSLATION_D_CONSTANT = 0;

    public static final double ROTATION_P_CONSTANT = .0293;
